...
class Interface(Frame):
    ...
    def content(self):
        ...
        self.counterlst = Listbox(self, yscrollcommand=self.counter_scrollbar.set,width=30)
        self.counter_scrollbar.config(command=self.counterlst.yview)

        self.counterlst.grid(column=0,row=7,rowspan=2,pady=(0,10), sticky=N+S+W)
